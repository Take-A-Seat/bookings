module github.com/Take-A-Seat/bookings

go 1.14

require (
	github.com/Take-A-Seat/auth v0.0.0-20210516081342-2f26fb1c378d
	github.com/Take-A-Seat/storage v0.0.0-20210612214226-4ff96f7a97f6
	github.com/Take-A-Seat/storage/ws v0.0.0-20210612214548-97f5ef4d738a // indirect
